...
// // // //     let category = params.get("category"); // is the string "Jonathan"
...
// // // //                 $(".content").html("<div class='display-container'></div>");
// // // //                 $(".display-container").append("<div class = 'card-container'></div>");
...
// // // //                             <p class="card-text  mx-5 " id="mov-year" ><strong>${movie.Year}</strong></p>
// // // //                             <p class="card-text   "id="txt-height"><small class="text-muted"><strong>${movie.Details}</strong></small></p>
// // // //                         </div>
// // // //                         </div>
// // // //                     </div>
// // // //                 </div>
